      ...
      <div className="container mt-64 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
        <section className="w-full">
          ...
          <div className="w-full grid lg:grid-cols-2 gap-8 lg:gap-32 mt-24">
            <form action="#">
              <div className="space-y-12">
                <div>
                  ...
                  <input type="text" className="focus:ring-indigo-500 focus:border-indigo-500 w-full border border-input-border bg-input px-4 py-4 focus-visible:border-indigo-500" />
                </div>
                <div>
                  <label className="text-white block mb-6 text-xl font-bold">Email</label>
                  <input type="email" className="focus:ring-indigo-500 focus:border-indigo-500  w-full border border-input-border bg-input px-4 py-4" />
                </div>
                <div>
                  <label className="text-white block mb-6 text-xl font-bold">Message</label>
                  <textarea type="text" className="focus:ring-indigo-500 focus:border-indigo-500 w-full border border-input-border bg-input px-4 py-4 h-56 resize-none"></textarea>
                </div>
            ...
            <div className="mt-12">
              <p className="text-secondary">+8801-6740-70166</p>
              <a href="mailto:utshaw.cse.1614.eu.bd@gmail.com" className="text-secondary underline mt-3 block">
                utshaw.cse.1614.eu.bd@gmail.com
              </a>
              <div className="flex mt-20 space-x-6 items-center">
              <a href="https://github.com/utshaweu" target="_blank">
                  <svg className="w-8 h-8 lg:w-12 lg:h-12" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none">
                    {" "}
                    <path
                ...
                <a href="https://www.linkedin.com/in/utshaweu" target="_blank">
                  <svg className="w-8 h-8 lg:w-12 lg:h-12" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 30 30" fill="none">
                    {" "}
                ...
                <a href="https://join.skype.com/invite/fgnosUiwmlsf" target="_blank">
                  <svg className="w-8 h-8 lg:w-12 lg:h-12" width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                ...
                <a href="https://twitter.com/utshaw_eu" target="_blank">
                  <svg className="w-8 h-8 lg:w-10 lg:h-10" width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
