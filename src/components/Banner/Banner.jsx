...
import myPic from "../../Assets/img/image.png";
    ...
    <>
      <div className="container mt-16 flex justify-between items-center mx-auto px-8 md:px-14 lg:px-24 w-full">
        <div className="flex flex-wrap md:flex-nowrap">
          <nav className="lg:mr-24 lg:w-4 fixed left-percentage hidden xl:block z-20">
          ...
          <div className="flex justify-center items-center">
            <img src={myPic} alt="Man" className="w-1/3 md:absolute -mt-4 md:mt-0 right-0 -z-1 object-fill" />
          </div>
        </div>
      </div>
    </>
